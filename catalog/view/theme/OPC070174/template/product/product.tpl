  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="productpage <?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="row">
		...
		<?php if ($column_left && $column_right) { ?>
        <?php $class = 'col-sm-6 image-box'; ?>
        <?php } elseif ($column_left || $column_right) { ?>
        <?php $class = 'col-sm-6 image-box'; ?>
        <?php } else { ?>
        <?php $class = 'col-sm-8 image-box'; ?>
        <?php } ?>
    ...
    <?php } ?>
        ...
        <?php if ($column_left && $column_right) { ?>
        <?php $class = 'col-sm-6 product-desc'; ?>
        <?php } elseif ($column_left || $column_right) { ?>
        <?php $class = 'col-sm-6 product-desc'; ?>
        <?php } else { ?>
        <?php $class = 'col-sm-4 product-desc'; ?>
        <?php } ?>
	    ...
	    <div class="<?php echo $class; ?>">
          ...
          <div id="product">	
            ...
            <div class="form-group cart">
              <label class="control-label input-quantity" for="input-quantity"><?php echo $entry_qty; ?></label>
              <input type="text" name="quantity" value="<?php echo $minimum; ?>" size="2" id="input-quantity" class="form-control" />
              <input type="hidden" name="product_id" value="<?php echo $product_id; ?>" />
            
				  <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-lg btn-block"><?php echo $button_cart; ?></button> <span class="or"><?php echo "- OR -" ;?></span>
				  <div class="btn-group">
					<button type="button"  class="btn btn-default" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><span><?php echo $button_wishlist; ?></span></button><br/>
					<button type="button"  class="btn btn-default" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><span><?php echo $button_compare; ?></span></button>
				 </div>
            </div>
            <?php if ($minimum > 1) { ?>
          ...
          <div class="rating">
            <div class="rating-star">
              ...
              <?php } ?>
              <?php } ?>
              <a class="review-rating"href="" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><?php echo $reviews; ?></a><a  class="review" href="" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><?php echo $text_write; ?></a></div>
		...
		<div id="products-related" class="related-products">
			...
			<?php /*?>		  <?php } ?><?php */?>
					...
					<div class="button-group">
						<button type="button" class="button_cart"onclick="cart.add('<?php echo $product['product_id']; ?>');"><span><?php echo $button_cart; ?></span></button>
						<button type="button" class="related-wishlist" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i></button>
						<button type="button" class="related-compare" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-exchange"></i></button>
					</div>
